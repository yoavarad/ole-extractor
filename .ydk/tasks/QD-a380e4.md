---
id: QD-a380e4
title: un-ignore dotnet-build in pre-push hook, now fixed by T-eeb6684b
status: done
type: quickdev
updated: '2026-08-22T18:00:40Z'
labels:
- in-review
---

un-ignore dotnet-build in pre-push hook, now fixed by T-eeb6684b
### 2026-08-22T18:00:40Z (UTC)
## Verification Proof

OK dotnet-build (1.4s)
OK dotnet-format (14.1s)
...
PR: https://github.com/yoavarad/ole-extractor/pull/5