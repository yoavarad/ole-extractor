...
component_refs: []
test_strategy: 'Manual verification: dotnet build ExtractorOLE/ExtractorOLE.csproj from a clean checkout
  succeeds with exit code 0.'
acceptance_criteria:
- text: ExtractorOLE.csproj TargetFramework element is net8.0
  done: false
- text: dotnet build ExtractorOLE/ExtractorOLE.csproj succeeds with no new warnings/errors introduced
    by the framework change
  done: false
